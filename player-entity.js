...
export const player_entity = (() => {
  ...
  class CharacterFSM extends finite_state_machine.FiniteStateMachine {
    ...
    _Init() {
      ...
      this._AddState('walk back', player_state.WalkBackState);
  ...
  class BasicCharacterController extends entity.Component {
    ...
    _LoadModels() {
      ...
      loader.setPath('../mesozoic-resources/glb/people/');
      loader.load('swat.glb', (glb) => {
        ...
        // this._target = useGLTF('./mesozoic-resources/glb/people/swat-1.glb');
        ...
        this._animations['walk'] = _FindAnim('run');
        this._animations['run'] = _FindAnim('run');
        this._animations['attack'] = _FindAnim('idle');
        this._animations['death'] = _FindAnim('die')

        this._stateMachine.SetState('idle');
      });
      // const loader = new FBXLoader();
      // loader.setPath('../mesozoic-resources/fbx/people/');
      ...
      //   loader.setPath('../mesozoic-resources/fbx/anims/');
      ...
      //   loader.load('swat-walkback.fbx', (a) => { _OnLoad('walk back', a); });
  ...
  class JoystickController extends entity.Component {
    ...
    _LoadModels() {
      ...
      loader.load('swat.glb', (glb) => {
        this._target = glb.scene;
        this._target.scale.set(25, 12.5, 12.5);
        this._params.scene.add(this._target);
        this._target.position.copy(this._parent._position);
    ...
    Update(timeInSeconds) {
      ...
      const input = this.GetComponent('Joystick');
      this._stateMachine.Update(timeInSeconds, input);
